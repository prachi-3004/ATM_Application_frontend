...
const TransferPage = () => {
    ...
    const getRecipientAccount = async(recipientId) => {
        var res1 = await axios.get("https://localhost:44307/api/Account/GetAccountByID/"+recipientId, {
            headers,
        });
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    Enter the recipient's account no.: <input type="text" value={recipientId} onChange={handleRecipientId}   required/>
                </div>
                <div>
